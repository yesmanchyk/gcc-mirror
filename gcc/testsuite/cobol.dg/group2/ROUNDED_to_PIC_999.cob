      ...
      *> { dg-do run }
       *> { dg-output-file "group2/ROUNDED_to_PIC_999.out" }
        ...
        01 aaa              pic s999v9.
        01 bbb              pic s999.
        01 should_be        pic s999.
        01 answers.
        02 answer           pic s999 occurs 7 times.
        01 methods.
        ...
        procedure                   division.
            ...
            move 0.1 to aaa
            move 1 to answer(1)  *> away-from-zero
            move 0 to answer(2)  *> nearest-away-from-zero
            move 0 to answer(3)  *> nearest-even
            move 0 to answer(4)  *> nearest-toward-zero
            move 1 to answer(5)  *> toward-greater
            move 0 to answer(6)  *> toward-lesser
            move 0 to answer(7)  *> truncation
            ...
            move 0.5 to aaa
            move 1 to answer(1)  *> away-from-zero
            move 1 to answer(2)  *> nearest-away-from-zero
            move 0 to answer(3)  *> nearest-even
            move 0 to answer(4)  *> nearest-toward-zero
            move 1 to answer(5)  *> toward-greater
            move 0 to answer(6)  *> toward-lesser
            ...
            move  0   to answer(3)  *> nearest-even
            move  0   to answer(4)  *> nearest-toward-zero
            move  0   to answer(5)  *> toward-greater
            move -1   to answer(6)  *> toward-lesser
            move  0   to answer(7)  *> truncation
            move 1 to methi perform reportt.
            move 2 to methi perform reportt.
            move 3 to methi perform reportt.
