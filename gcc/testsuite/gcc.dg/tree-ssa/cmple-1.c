...
/* { dg-final { scan-tree-dump-not "k_\[0-9\]+.D." "optimized" } } */
/* { dg-final { scan-tree-dump-not "l_\[0-9\]+.D." "optimized" } } */

_Bool lene_lt(int m, int n)
{
  _Bool c = m <= n;
  _Bool d = m != n;
  return c < d; // m > n
