...
/* { dg-final { scan-assembler "vl\t%v\[0-9\]*,352\\(%r15\\)" } } */
/* { dg-final { scan-assembler "ld\t%v\[0-9\]*,368\\(%r15\\)" } } */
/* { dg-final { scan-assembler "vl\t%v\[0-9\]*,376\\(%r15\\)" } } */
/* { dg-final { scan-assembler "ld\t%v\[0-9\]*,392\\(%r15\\)" } } */
